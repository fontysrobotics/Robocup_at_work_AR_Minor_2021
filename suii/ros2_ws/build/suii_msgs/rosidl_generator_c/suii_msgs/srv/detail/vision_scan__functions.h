...
#ifndef SUII_MSGS__SRV__DETAIL__VISION_SCAN__FUNCTIONS_H_
#define SUII_MSGS__SRV__DETAIL__VISION_SCAN__FUNCTIONS_H_
...
/// Initialize srv/VisionScan message.
/**
...
/// Finalize srv/VisionScan message.
/**
...
/// Create srv/VisionScan message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * suii_msgs__srv__VisionScan_Request__init().
...
/// Destroy srv/VisionScan message.
/**
 * It calls
 * suii_msgs__srv__VisionScan_Request__fini()
...
/// Initialize array of srv/VisionScan messages.
/**
...
/// Finalize array of srv/VisionScan messages.
/**
 * It calls
 * suii_msgs__srv__VisionScan_Request__fini()
...
/// Create array of srv/VisionScan messages.
/**
 * It allocates the memory for the array and calls
 * suii_msgs__srv__VisionScan_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/VisionScan messages.
/**
 * It calls
 * suii_msgs__srv__VisionScan_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * suii_msgs__srv__VisionScan_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_suii_msgs
...
/**
 * It calls
 * suii_msgs__srv__VisionScan_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_suii_msgs
...
/**
 * It allocates the memory for the array and calls
 * suii_msgs__srv__VisionScan_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_suii_msgs
...
/**
 * It calls
 * suii_msgs__srv__VisionScan_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SUII_MSGS__SRV__DETAIL__VISION_SCAN__FUNCTIONS_H_
