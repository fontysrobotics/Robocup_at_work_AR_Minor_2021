...
bool suii_msgs__srv__item__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("suii_msgs.srv._item.Item_Request", full_classname_dest, 32) == 0);
  }
  suii_msgs__srv__Item_Request * ros_message = _ros_message;
  {  // itemid
...
PyObject * suii_msgs__srv__item__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("suii_msgs.srv._item");
...
ROSIDL_GENERATOR_C_EXPORT
bool suii_msgs__srv__item__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("suii_msgs.srv._item.Item_Response", full_classname_dest, 33) == 0);
  }
  suii_msgs__srv__Item_Response * ros_message = _ros_message;
  {  // sucess
