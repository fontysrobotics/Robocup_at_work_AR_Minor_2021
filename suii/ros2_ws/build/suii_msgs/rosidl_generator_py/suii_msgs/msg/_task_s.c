...
bool suii_msgs__msg__task__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("suii_msgs.msg._task.Task", full_classname_dest, 24) == 0);
  }
  suii_msgs__msg__Task * ros_message = _ros_message;
  {  // id
...
PyObject * suii_msgs__msg__task__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("suii_msgs.msg._task");
