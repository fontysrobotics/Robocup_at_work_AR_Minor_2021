...
static const _ManipulationPose_Request_type_support_symbol_names_t _ManipulationPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, suii_msgs, srv, ManipulationPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, suii_msgs, srv, ManipulationPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, suii_msgs, srv, ManipulationPose_Request)() {
  return &::suii_msgs::srv::rosidl_typesupport_c::ManipulationPose_Request_message_type_support_handle;
}
...
static const _ManipulationPose_Response_type_support_symbol_names_t _ManipulationPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, suii_msgs, srv, ManipulationPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, suii_msgs, srv, ManipulationPose_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_suii_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, suii_msgs, srv, ManipulationPose_Response)() {
  return &::suii_msgs::srv::rosidl_typesupport_c::ManipulationPose_Response_message_type_support_handle;
}
...
static const _ManipulationPose_type_support_symbol_names_t _ManipulationPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, suii_msgs, srv, ManipulationPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, suii_msgs, srv, ManipulationPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, suii_msgs, srv, ManipulationPose)() {
  return &::suii_msgs::srv::rosidl_typesupport_c::ManipulationPose_service_type_support_handle;
}
