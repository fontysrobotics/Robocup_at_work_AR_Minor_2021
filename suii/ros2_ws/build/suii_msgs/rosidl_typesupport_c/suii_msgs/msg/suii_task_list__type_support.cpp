...
static const _SuiiTaskList_type_support_symbol_names_t _SuiiTaskList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, suii_msgs, msg, SuiiTaskList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, suii_msgs, msg, SuiiTaskList)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, suii_msgs, msg, SuiiTaskList)() {
  return &::suii_msgs::msg::rosidl_typesupport_c::SuiiTaskList_message_type_support_handle;
}
