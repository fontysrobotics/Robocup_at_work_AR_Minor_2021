...
#include <stddef.h>
#include "suii_msgs/msg/detail/task__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  suii_msgs__msg__Task__init(message_memory);
}

void Task__rosidl_typesupport_introspection_c__Task_fini_function(void * message_memory)
{
  suii_msgs__msg__Task__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Task__rosidl_typesupport_introspection_c__Task_message_member_array[2] = {
  {
    "id",  // name
    ...
    offsetof(suii_msgs__msg__Task, id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(suii_msgs__msg__Task, pose),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, suii_msgs, msg, Task)() {
  Task__rosidl_typesupport_introspection_c__Task_message_member_array[1].members_ =
