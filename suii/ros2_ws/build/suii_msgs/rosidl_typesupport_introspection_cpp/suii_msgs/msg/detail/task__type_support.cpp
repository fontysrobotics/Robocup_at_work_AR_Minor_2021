...
{
  new (message_memory) suii_msgs::msg::Task(_init);
}

void Task_fini_function(void * message_memory)
{
  auto typed_message = static_cast<suii_msgs::msg::Task *>(message_memory);
  typed_message->~Task();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Task_message_member_array[2] = {
  {
    ...
    offsetof(suii_msgs::msg::Task, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(suii_msgs::msg::Task, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::suii_msgs::msg::rosidl_typesupport_introspection_cpp::Task_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, suii_msgs, msg, Task)() {
  return &::suii_msgs::msg::rosidl_typesupport_introspection_cpp::Task_message_type_support_handle;
}
