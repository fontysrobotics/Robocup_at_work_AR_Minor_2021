...
static const _ItemPick_Request_type_support_symbol_names_t _ItemPick_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, suii_msgs, srv, ItemPick_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, suii_msgs, srv, ItemPick_Request)),
  }
};
...
{
  return &::suii_msgs::srv::rosidl_typesupport_cpp::ItemPick_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, suii_msgs, srv, ItemPick_Request)() {
  return get_message_type_support_handle<suii_msgs::srv::ItemPick_Request>();
}
...
static const _ItemPick_Response_type_support_symbol_names_t _ItemPick_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, suii_msgs, srv, ItemPick_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, suii_msgs, srv, ItemPick_Response)),
  }
};
...
{
  return &::suii_msgs::srv::rosidl_typesupport_cpp::ItemPick_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, suii_msgs, srv, ItemPick_Response)() {
  return get_message_type_support_handle<suii_msgs::srv::ItemPick_Response>();
}
...
static const _ItemPick_type_support_symbol_names_t _ItemPick_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, suii_msgs, srv, ItemPick)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, suii_msgs, srv, ItemPick)),
  }
};
...
{
  return &::suii_msgs::srv::rosidl_typesupport_cpp::ItemPick_service_type_support_handle;
}
