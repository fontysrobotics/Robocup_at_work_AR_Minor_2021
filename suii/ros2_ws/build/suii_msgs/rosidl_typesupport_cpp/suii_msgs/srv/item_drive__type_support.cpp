...
static const _ItemDrive_Request_type_support_symbol_names_t _ItemDrive_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, suii_msgs, srv, ItemDrive_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, suii_msgs, srv, ItemDrive_Request)),
  }
};
...
{
  return &::suii_msgs::srv::rosidl_typesupport_cpp::ItemDrive_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, suii_msgs, srv, ItemDrive_Request)() {
  return get_message_type_support_handle<suii_msgs::srv::ItemDrive_Request>();
}
...
static const _ItemDrive_Response_type_support_symbol_names_t _ItemDrive_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, suii_msgs, srv, ItemDrive_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, suii_msgs, srv, ItemDrive_Response)),
  }
};
...
{
  return &::suii_msgs::srv::rosidl_typesupport_cpp::ItemDrive_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, suii_msgs, srv, ItemDrive_Response)() {
  return get_message_type_support_handle<suii_msgs::srv::ItemDrive_Response>();
}
...
static const _ItemDrive_type_support_symbol_names_t _ItemDrive_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, suii_msgs, srv, ItemDrive)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, suii_msgs, srv, ItemDrive)),
  }
};
...
{
  return &::suii_msgs::srv::rosidl_typesupport_cpp::ItemDrive_service_type_support_handle;
}
