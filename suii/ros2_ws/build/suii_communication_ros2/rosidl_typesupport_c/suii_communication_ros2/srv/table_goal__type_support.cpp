...
#include "suii_communication_ros2/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _TableGoal_Request_type_support_symbol_names_t _TableGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, suii_communication_ros2, srv, TableGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, suii_communication_ros2, srv, TableGoal_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_suii_communication_ros2
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, suii_communication_ros2, srv, TableGoal_Request)() {
  return &::suii_communication_ros2::srv::rosidl_typesupport_c::TableGoal_Request_message_type_support_handle;
}
...
static const _TableGoal_Response_type_support_symbol_names_t _TableGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, suii_communication_ros2, srv, TableGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, suii_communication_ros2, srv, TableGoal_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_suii_communication_ros2
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, suii_communication_ros2, srv, TableGoal_Response)() {
  return &::suii_communication_ros2::srv::rosidl_typesupport_c::TableGoal_Response_message_type_support_handle;
}
...
static const _TableGoal_type_support_symbol_names_t _TableGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, suii_communication_ros2, srv, TableGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, suii_communication_ros2, srv, TableGoal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, suii_communication_ros2, srv, TableGoal)() {
  return &::suii_communication_ros2::srv::rosidl_typesupport_c::TableGoal_service_type_support_handle;
}
