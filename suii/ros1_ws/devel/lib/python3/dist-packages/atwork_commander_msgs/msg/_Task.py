...
"""autogenerated by genpy from atwork_commander_msgs/Task.msg. Do not edit."""
import codecs
import sys
...
class Task(genpy.Message):
  _md5sum = "23084b379239948be639bf4f943f476b"
  _type = "atwork_commander_msgs/Task"
...
"""
  __slots__ = ['execute_on','arena_start_state','arena_target_state','prep_time','exec_time','type','id']
  _slot_types = ['atwork_commander_msgs/RobotHeader[]','atwork_commander_msgs/Workstation[]','atwork_commander_msgs/Workstation[]','duration','duration','string','uint64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       execute_on,arena_start_state,arena_target_state,prep_time,exec_time,type,id
    ...
    if args or kwds:
      ...
      if self.execute_on is None:
        self.execute_on = []
      if self.arena_start_state is None:
        self.arena_start_state = []
      if self.arena_target_state is None:
        self.arena_target_state = []
    ...
    try:
      ...
      for val1 in self.execute_on:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.arena_start_state)
      buff.write(_struct_I.pack(length))
      for val1 in self.arena_start_state:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.arena_target_state)
      buff.write(_struct_I.pack(length))
      for val1 in self.arena_target_state:
        length = len(val1.objects)
        buff.write(_struct_I.pack(length))
        for val2 in val1.objects:
          _x = val2
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if self.arena_start_state is None:
        self.arena_start_state = None
      if self.arena_target_state is None:
        self.arena_target_state = None
      if self.prep_time is None:
        self.prep_time = genpy.Duration()
      if self.exec_time is None:
        self.exec_time = genpy.Duration()
      ...
      for i in range(0, length):
        ...
        self.arena_start_state.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.arena_target_state = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.workstation_name = str[start:end]
        self.arena_target_state.append(val1)
      _x = self
      start = end
      end += 16
