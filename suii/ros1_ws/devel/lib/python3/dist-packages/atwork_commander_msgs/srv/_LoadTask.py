...
"""autogenerated by genpy from atwork_commander_msgs/LoadTaskRequest.msg. Do not edit."""
import codecs
import sys
...
class LoadTaskRequest(genpy.Message):
  _md5sum = "320ae3adc870aff0e94ed6fe1487ffbf"
  _type = "atwork_commander_msgs/LoadTaskRequest"
...
"""
  __slots__ = ['task']
  _slot_types = ['atwork_commander_msgs/Task']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LoadTaskRequest, self).__init__(*args, **kwds)
...
def _get_struct_Q():
    ...
    return _struct_Q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from atwork_commander_msgs/LoadTaskResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class LoadTaskResponse(genpy.Message):
  _md5sum = "eca8b96616c32aacf1be8bbf14c70eba"
  _type = "atwork_commander_msgs/LoadTaskResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LoadTaskResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
class LoadTask(object):
  _type          = 'atwork_commander_msgs/LoadTask'
  _md5sum = 'f94a92de0a9d926d38fa9af9eb8b4091'
  _request_class  = LoadTaskRequest
  _response_class = LoadTaskResponse
