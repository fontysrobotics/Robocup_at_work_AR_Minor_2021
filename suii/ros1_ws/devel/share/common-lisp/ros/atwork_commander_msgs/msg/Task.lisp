...
(cl:defclass <Task> (roslisp-msg-protocol:ros-message)
  ((execute_on
   ...
   (arena_start_state
    :reader arena_start_state
    :initarg :arena_start_state
   ...
   (arena_target_state
    :reader arena_target_state
    :initarg :arena_target_state
    :type (cl:vector atwork_commander_msgs-msg:Workstation)
   :initform (cl:make-array 0 :element-type 'atwork_commander_msgs-msg:Workstation :initial-element (cl:make-instance 'atwork_commander_msgs-msg:Workstation)))
   (prep_time
    :reader prep_time
...
(cl:defmethod cl:initialize-instance :after ((m <Task>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Task)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atwork_commander_msgs-msg:<Task> is deprecated: use atwork_commander_msgs-msg:Task instead.")))

(cl:ensure-generic-function 'execute_on-val :lambda-list '(m))
(cl:defmethod execute_on-val ((m <Task>))
...
(cl:ensure-generic-function 'arena_start_state-val :lambda-list '(m))
(cl:defmethod arena_start_state-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atwork_commander_msgs-msg:arena_start_state-val is deprecated.  Use atwork_commander_msgs-msg:arena_start_state instead.")
  (arena_start_state m))

(cl:ensure-generic-function 'arena_target_state-val :lambda-list '(m))
(cl:defmethod arena_target_state-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atwork_commander_msgs-msg:arena_target_state-val is deprecated.  Use atwork_commander_msgs-msg:arena_target_state instead.")
  (arena_target_state m))

(cl:ensure-generic-function 'prep_time-val :lambda-list '(m))
(cl:defmethod prep_time-val ((m <Task>))
...
(cl:defmethod exec_time-val ((m <Task>))
...
(cl:defmethod type-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atwork_commander_msgs-msg:type-val is deprecated.  Use atwork_commander_msgs-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atwork_commander_msgs-msg:id-val is deprecated.  Use atwork_commander_msgs-msg:id instead.")
  (id m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Task>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'arena_start_state))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'arena_start_state))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'arena_target_state))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'arena_target_state))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Task>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'arena_start_state) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'arena_start_state)))
    (cl:dotimes (i __ros_arr_len)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'arena_target_state) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'arena_target_state)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'atwork_commander_msgs-msg:Workstation))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Task>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'arena_start_state) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'arena_target_state) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Task>))
  ...
  (cl:list 'Task
    ...
    (cl:cons ':arena_start_state (arena_start_state msg))
    (cl:cons ':arena_target_state (arena_target_state msg))
